...
[LR_WILDS] = LAYOUT_split_3x6_3(
    // 1st row:
    MRS_GRAVE, MRS_AT, MRS_HASH, MRS_DLR, MRS_PRCNT, MRS_CIRC,              MRS_MINUS, MRS_EXLM, MRS_AMPR, MRS_PIPE, MRS_SLSH, MRS_BSLSH,
    // 2nd row:
    KC_LSFT, KC_NO, KC_NO, MRS_LBRC, MRS_RBRC, KC_NO,                       MRS_EQUAL, MRS_QUES, MRS_COLON, MRS_QUOTE, MRS_ASTRX, KC_BSPC,
    // 3rd row:
    KC_LCTL, KC_NO, KC_NO, MRS_LPRNT, MRS_RPRNT, KC_NO,                     KC_NO, KC_NO, MRS_LT, MRS_GT, MRS_RU_DOT, MRS_SLSH,
    // 4th row:
